...
class search_class extends AWS_MODEL
{
	...
	public function prase_result_info($result_info,$q)
	{
		...
		else if ($result_info['question_id'])
		{
			...
			$result_info['question_detail']=strip_tags(FORMAT::parse_bbcode($result_info['question_detail']));
		...
		else if ($result_info['id'])
		{
			...
			$result_info['message']=strip_tags(FORMAT::parse_bbcode($result_info['message']));
