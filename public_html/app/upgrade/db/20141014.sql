CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]edm_unsubscription` (
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]users_google` (
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]users_facebook` (
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]users_twitter` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `uid` int(11) UNSIGNED NOT NULL,
  `name` varchar(128) DEFAULT NULL,
