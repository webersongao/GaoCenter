INSERT IGNORE INTO `[#DB_PREFIX#]system_setting` (`varname`, `value`) VALUES ('new_question_force_add_topic', 's:1:"N";');
INSERT IGNORE INTO `[#DB_PREFIX#]system_setting` (`varname`, `value`) VALUES ('unfold_question_comments', 's:1:"N";');
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]article_comments` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `[#DB_PREFIX#]article_vote` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
...
ALTER TABLE `[#DB_PREFIX#]topic_question` ADD `type` VARCHAR( 16 ) NULL;
ALTER TABLE `[#DB_PREFIX#]topic_question` ADD INDEX ( `type` );
