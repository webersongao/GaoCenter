...
INSERT IGNORE INTO `[#DB_PREFIX#]system_setting` (`varname`, `value`) VALUES ('register_valid_type', 's:5:"email";');
INSERT IGNORE INTO `[#DB_PREFIX#]system_setting` (`varname`, `value`) VALUES ('wecenter_access_token', 's:0:"";');
...
INSERT IGNORE INTO `[#DB_PREFIX#]system_setting` (`varname`, `value`) VALUES ('wecenter_access_secret', 's:0:"";');
...
ALTER TABLE `[#DB_PREFIX#]notice` ADD `sender_remove` TINYINT( 1 ) NULL DEFAULT '0';
ALTER TABLE `[#DB_PREFIX#]notice` ADD `recipient_remove` TINYINT( 1 ) NULL DEFAULT '0';
