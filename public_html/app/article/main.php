...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		TPL::assign('article_related_list', $this->model('article')->get_related_article_list($article_info['id'], $article_info['title']));
	...
	public function index_square_action()
	{
		...
		if ($article_list)
		{
			...
			foreach ($article_list AS $key => $val)
			{
				...
				if ($val['article_img']) {
					$article_list[$key]['article_img'] = get_setting('upload_url') . '/article/cover/'.$val['article_img'];	
				}else{
					$article_list[$key]['article_img'] = '/static/css/default/img/default-cover.jpg';
				}
			}
		}
