...
class ajax extends AWS_ADMIN_CONTROLLER
{
    ...
    public function save_category_action()
    {
        ...
        {
            $category_id = $this->model('category')->add_category($category_type, $_POST['title'], $_POST['parent_id'],$_POST['url_token']);
        }
        ...
        $this->model('category')->update_category_info($category_id, $_POST['title'], $_POST['parent_id'], $_POST['url_token'],$category_type);
    ...
    public function add_nav_menu_action()
    {
        ...
        $this->model('menu')->add_nav_menu($title, $description, $_POST['type'], $type_id, $link,$category_type);
