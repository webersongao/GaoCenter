...
class ajax extends AWS_CONTROLLER
{
	...
	public function publish_project_action()
	{
		...
		{
			H::ajax_json_output(AWS_APP::RSM(null, - 1, AWS_APP::lang()->_t('请输入活动详情')));
		}else{
			$_POST['description'] = filter_Emoji($_POST['description']);
		}

		if (!$_POST['summary'])
		{
			H::ajax_json_output(AWS_APP::RSM(null, - 1, AWS_APP::lang()->_t('请输入活动简介')));
		}else{
			$_POST['summary'] = filter_Emoji($_POST['summary']);
		}
