		...
		'<div class="modal fade alert-box aw-login-box">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					'<div class="modal-header">'+
						'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
						'<h3 class="modal-title" id="myModalLabel">' + _t('账户登陆') + '</h3>'+
					'</div>'+
					'<div class="modal-body">'+
							...
							'<input type="hidden" name="return_url" value="{{return_url}}" />'+
								'<ul>'+
									...
									'<li class="last" style="overflow: hidden;">'+
										...
										'<a href="account/openid/qq/bind/?return_url={{return_url}}" class="btn btn-large btn-qq"><i class="icon icon-qq"></i> QQ登录</a>'+
										'<a href="account/openid/weibo/bind/?return_url={{return_url}}" class="btn btn-large btn-weibo"><i class="icon icon-weibo"></i> 微博登录</a>'+
									'</li>'+
									'<li>'+
