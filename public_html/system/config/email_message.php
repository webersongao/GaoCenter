...
$config['VALID_EMAIL'] = array(
	...
	'message' => "欢迎注册 [#site_name#] , 请点击下面的链接完成邮箱验证(无法跳转时请拷贝链接到浏览器打开)"
);
...
$config['QUESTION_DEL'] = array(
	...
	'message' => "您发表的问题 [#question_title#] 已被管理员删除<br /><br />---------- 所删除的内容 ----------<br /><br />[#question_detail#]<br /><br />-----------------------------<br /><br />如有疑问, 请及时联系管理员",
);

$config['REGISTER_DECLINE'] = array(
	'subject' => "您在 [#site_name#] 的注册申请未通过审核",
	'message' => "您在 [#site_name#] 的注册申请未通过审核<br /><br />---------- 原因 ----------<br /><br />[#message#]<br /><br />----------------------------------<br /><br />如有疑问, 请及时联系管理员",
);
